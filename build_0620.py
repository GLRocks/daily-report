#!/usr/bin/env python3
"""Generate 2026-06-20 report from 2026-06-19 base with fresh weekend content."""

# Read base file
with open('/root/.openclaw/workspace/daily_report_2026-06-19.html', 'r') as f:
    lines = f.readlines()

# Keep header + CSS + S1 (lines 0-470, 0-indexed)
header_s1 = ''.join(lines[:471])

# Keep footer (lines 892-end, 0-indexed)
footer = ''.join(lines[892:])

# Update date in header
header_s1 = header_s1.replace('<title>Agentic Market Daily | 2026-06-19</title>', '<title>Agentic Market Daily | 2026-06-20</title>')
header_s1 = header_s1.replace(
